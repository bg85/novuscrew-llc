...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "home.loyaltyApp" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("loyaltyApp", withExtension: "momd")!
...
//        // iCloud - Core Data Code
//        var storeOptions = [NSPersistentStoreUbiquitousContentNameKey : "loyaltyAppSF"
//            // NSPersistentStoreRebuildFromUbiquitousContentOption: @(true)
//        ]
//        self.registerCoordinatorForStoreNotifications (coordinator)
//        //End iCloud - Core Data Code
...
//    }
//    
//    func handleStoresWillChange(coordinator : NSPersistentStoreCoordinator) {
...
//    }
//
//    func handleStoresDidChange(coordinator : NSPersistentStoreCoordinator) {
//        //Update UI
//        unBlockUI()
//    }
//    
//    func handleStoreChangedUbiquitousContent(coordinator : NSPersistentStoreCoordinator, note: NSNotification) {
//        self.managedObjectContext.performBlock { () -> Void in
...
//            if progressView == nil {
//                progressView = factory.getProgressView()
//            }
